 ...
 */
export function loopbackInterface(family?: 'ipv4' | 'ipv6'): os.NetworkInterfaceInfo;
 ...
 * @param family The family can be either "ipv4" or "ipv6". Default: "ipv4".
 */
export function networkInterface(name?: 'public' | 'private' | string, family?: 'ipv4' | 'ipv6'): os.NetworkInterfaceInfo;
