...
import {getSensorDataTimeline} from "../../api/Sensor";

export default class TemperatureOverview extends Component {

    constructor(props) {
        super(props);
        this.state = {chartData: [], filter: "W"};
    }

    componentDidMount() {
        getSensorDataTimeline(this.props.sensor.uuid, "temp").then(
            data => this.setState({
    ...
    render() {
        ...
        return <Grid className="mt-6" numCols="2">
            <Col className="m-2">
                <Card>
                    <Title>
            ...
            <Col className="m-2">
                <SensorSettings sensor={this.props.sensor}/>
            </Col>
        </Grid>
    }
